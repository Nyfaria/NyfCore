package com.nyfaria.nyfcore.cap;
...
@Mod.EventBusSubscriber(modid = NyfCore.MODID)
public class ExampleHolderAttacher extends CapabilityAttacher {
    ...
    public static final ResourceLocation EXAMPLE_RL = new ResourceLocation(NyfCore.MODID, "example");
