...
import com.nyfaria.nyfcore.entity.ai.ifaces.ISemiAquatic;
...
public class SemiAquaticAIRandomSwimming<T extends Animal & ISemiAquatic> extends RandomStrollGoal {

    public final T mob;
    public SemiAquaticAIRandomSwimming(T creature, double speed, int chance) {
        super(creature, speed, chance, false);
        this.mob = creature;
    }

    public boolean canUse() {
        if (this.mob.isVehicle() || mob.shouldStopMoving() || mob.getTarget() != null || !this.mob.isInWater() && !this.mob.isInLava() && !this.mob.shouldEnterWater()) {
            return false;
        } else {
